...
import { Moon, Sun, RefreshCw, Activity, Settings, ArrowLeft, Menu, BarChart2, Plus, Syringe, Calculator, LogOut, CalendarDays, CalendarRange } from 'lucide-react';
...
export function Header({ lastUpdated }: HeaderProps) {
  ...
  const isSubpage = ['/settings', '/comparisons', '/treatments', '/calendar', '/weekly'].includes(location.pathname);
