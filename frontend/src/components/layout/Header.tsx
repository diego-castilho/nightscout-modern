...
import { Moon, Sun, RefreshCw, Activity, Settings, ArrowLeft, Menu, BarChart2, BarChart, Plus, Syringe, Calculator, LogOut, CalendarDays, CalendarRange, Clock, BookOpen, Utensils } from 'lucide-react';
...
export function Header({ lastUpdated }: HeaderProps) {
  ...
  const isSubpage = ['/settings', '/comparisons', '/treatments', '/calendar', '/weekly', '/hourly', '/distribution', '/daily', '/meals'].includes(location.pathname);
